...
Oh My OpenCode provides complete transparency into AI decision-making processes. Unlike traditional AI systems that operate as "black boxes," you can see exactly how and why routing decisions are made.
...
💭 **Routing Logic**: Query involves multiple complex tasks requiring expert analysis
...
```bash
show_routing_decision({ query: "Implement authentication system" })
```

This provides detailed analysis including complexity assessment, agent recommendations, and decision signals.

#### 📋 Agent Selection Guide

**Low Sisyphus**: LIGHT tasks - cost-effective, fast responses ⚡
• Simple questions, basic implementations
• Code explanations, quick fixes
...
• Full-stack applications, complex architectures
• Multi-component systems, advanced integrations

**Benefits:**
- ✅ **Trust Building**: Understand AI decision processes
- ✅ **Debugging**: Identify routing issues quickly
- ✅ **Optimization**: Choose appropriate agents manually when needed
- ✅ **Cost Control**: See cost-benefit analysis for each decision
